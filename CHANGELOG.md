...
- **`docs/specs/machine-memory.md`.** Typed facts with receipts, bi-temporal supersession, and pull hydration -- the spec for what a session remembers across restarts and why markdown alone is not the tax (542 vs 1,552 tokens, measured). (#162)
