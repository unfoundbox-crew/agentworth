...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t-2 border-zinc-900 bg-[#f8f9fa] text-black font-mono text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        
        {/* Architecture ASCII Flow */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center border border-zinc-900 bg-white p-6 sm:p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div>
            <div className="inline-block border border-zinc-900 px-2 py-0.5 bg-zinc-100 mb-2 font-bold text-[10px] uppercase">
              ZERO TELEMETRY GUARANTEE
            </div>
            <h3 className="text-xl font-bold uppercase mb-2">LOCAL MEANS LOCAL</h3>
            <p className="text-zinc-600 text-xs leading-relaxed mb-4">
              AgentWorth indexes traces directly from your local filesystem into a local SQLite database at <code className="bg-zinc-100 px-1 py-0.5 border border-zinc-300">~/.agentworth/agentworth.db</code>. No servers, no tracking, no external API calls.
            </p>
            <div className="flex items-center space-x-3 text-xs">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-bold underline hover:text-zinc-600"
              >
                Apache 2.0 / MIT
              </a>
            </div>
