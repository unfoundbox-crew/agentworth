...
_Generated by `agentworth docs --write` from v0.1.15 on 2026-09-02. Do not edit by hand -- regenerate with `agentworth docs --write` (see `apps/cli/src/commands/docs.rs`)._
