...
_Generated by `archie docs --write` from v0.1.27 on 2026-09-23. Do not edit by hand -- regenerate with `archie docs --write` (see `apps/cli/src/commands/docs.rs`)._
...
The deterministic machine-insights payload: usable sessions, tool calls, evidence ladder, per-model burn, biggest sessions (same JSON as `agentworth insights --json`)
